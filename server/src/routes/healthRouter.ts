 ...
 *
 * It exists separately from `/` because the SPA fallback answers only requests
 * that ask for text/html, and a health checker sends `Accept: * / *` — it would
 * get a JSON 404 and mark a perfectly good deploy as failed.
 *
